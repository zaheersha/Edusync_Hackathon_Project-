        ...
        <div class="row">
            <div class="box">
             ...
             <!--- /*  <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/abt1.jpeg" alt="">
                    <h3>James Moore</h3>
                </div>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/abt2.jpeg" alt="">
                    <h3>Jane Brown</h3>
                </div>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/abt3.jpeg" alt="">
                    <h3>Anne Marie</h3>
                </div> */-->
               <center>
                <br><br>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/abt5.jpeg" alt="">
                    <h3>CLOUDIZ</h3>
                </div> <br><br>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/abt7.jpeg" alt="">
                    <h3>ZAHEER SHA -TL</h3>
                </div>
                <div class="col-sm-4 text-center">
                    <img class="img-responsive" src="img/abt6.jpeg" alt="">
                    <h3>CLOUDIZ</h3>
                    </center>
                <div class="clearfix"></div>
            </div>
